...
| **BiS Manager** | Submissions / BiS Lists | Submissions: open/close BiS submissions globally or per player; approve or reject submitted links. BiS Lists: role-grouped player table with each raider's wishlist BiS count and an Incomplete Wishlists badge. |
...
deno task test         # their tests under tests/edge/, no permissions granted
...
npm run dev:login -- phoenix-officer   # print a sign-in link for a persona; no name lists them
