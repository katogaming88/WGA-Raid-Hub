...
| Revamp 1: decisions and foundation | 5 h 40 m |
| **All revamp work** | **7 h 30 m** |
...
| 10:23 AM– | #1101 part 3a: Battle.net sign-in in the new app | Revamp 1 | in progress | build; test and review not yet counted | Sign-in, Connect Discord and Battle.net, "Use your Discord account" switch with `discard-empty-account`, roles once, officer gating, dialog and status components. Characters from Blizzard split to 3b |
