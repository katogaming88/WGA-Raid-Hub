...
- **The coverage map above** -- it is meant to classify all 46 base tables (seven are still unlisted, see the 2026-09-13 #1114 note below), so a new table leaves it incomplete without anything failing.
