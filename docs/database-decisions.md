...
- **`incoming_roster` joins `team_seasons` on the open switch** instead of `team_settings` on the key. Its bypass-RLS shape is unchanged; #503 makes it a function after this.
