...
var REQUIRED_SCHEMA = '20260913220137';
...
function renderProfile(firstName, backTo, container) {
  ...
  if (backTo === 'officer') {
    ...
    officerActionsHTML =
      ...
      '</select>' +
      '<input id="removePlayerReasonDetail-' +
      player.firstName +
      '" type="text" placeholder="Details..." style="font-size:1rem;padding:0.25rem 0.5rem;flex:1;min-width:8rem;" />' +
