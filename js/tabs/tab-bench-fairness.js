function buildBenchFairness() {
  ...
  if (!Array.isArray(_attendanceGrid) || !_attendanceGrid.length) {
    el.innerHTML =
      '<p style="color:var(--text-muted);padding:0.5rem 0;">No attendance data. Run "Refresh from WCL" on the Attendance tab first.</p>';
    return;
  }
  ...
  html +=
    '<div class="fairness-avg-legend"><span class="fairness-avg-line-swatch"></span>Avg: ' +
