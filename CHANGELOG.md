...
- **Small text across cards/boxes site-wide (progression, loot rows, stat boxes, admin panels) bumped up slightly** -- Rajdhani is a fairly thin font that was blurring at the smallest sizes used (mostly 0.65rem-0.97rem).
